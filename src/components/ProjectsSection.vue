...
const Projects = ref([
  {
    ...
    description:
      "My very own website made from scratch using various modern web technologies. Also, the website you are currently on!",
